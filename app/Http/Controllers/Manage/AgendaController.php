...
class AgendaController extends BaseController
{
    ...
    {
        parent::__construct();
        view()->share(['_model' => 'manage/agenda']);
    }
    ...
    public function postCreate(Request $request)
    {
        ...
        try {
            $agenda = new Agenda();
            $inputs = $request->all();
            $validator = Validator::make($inputs, $agenda->Rules(), $agenda->messages());
            if ($validator->fails()) {
                $respJson->setCode(2);
...
//                $job =new AgendaChangeJob($agenda);
