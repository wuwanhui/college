...
class WeixinUserController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $list = Weixin_User::where(function ($query) use ($request) {
            ...
            return view('manage.weixin.user.index', compact('list'));
        } catch (Exception $ex) {
            $respJson->setCode(-1);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $user = Weixin_User::find($request->id);
            if (!isset($user)) {
                $respJson->setCode(1);
    ...
    public function getCreate(Request $request)
    {
        $respJson = new RespJson();
        try {
            $user = new Weixin_User();
            return view('manage.weixin.user.create', compact('customer'));
        } catch (Exception $ex) {
            $respJson->setCode(-1);
            $respJson->setMsg('异常！' . $ex->getMessage());
            return response()->json($respJson);
    ...
    public function getEdit(Request $request)
    {
        ...
        try {
            ...
            return view('manage.weixin.user.edit', compact('customer'));
        } catch (Exception $ex) {
            $respJson->setCode(-1);
            $respJson->setMsg('异常！' . $ex->getMessage());
            return response()->json($respJson);
