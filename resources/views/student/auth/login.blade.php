...
<head>
    ...
    <title>管理员-{{ config('app.name', 'Laravel') }}</title>

    <!-- Styles -->
    <link href="/css/app.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/js/Awesome/css/font-awesome.css">
    <!-- Theme style -->
...
<div id="app">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg h4"><i class="icon-desktop"></i> 在线选课系统-学生入口</p>
