                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked ">
                            <li class="active"><a
                                        ...
                                        v-on:click="dept.id=0"><i class="fa fa-inbox"></i>顶级</a></li>
                            <li>

                            <li v-for="item in lists.data"><a v-text="item.name"
                                                              v-bind:class="{active:dept.id==item.id}"
                                                              v-on:click="dept=item"></a></li>
                            </li>
                        </ul>
                    </div>
                </div>
                <a href="compose.html" class="btn btn-primary btn-block margin-bottom">新增顶级机构</a>
            </div>
