...
<div class="wrapper" id="app">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>{{config('app.name', 'Laravel')}}</b>v1.0</span>
        </a>
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="{{url('/manage/resources/lineclass')}}"><i class="fa fa-circle-o"></i>线路类别</a>
                            </li>
                            <li>
                                <a href="{{url('/manage/resources/dept')}}"><i class="fa fa-circle-o"></i>线路行程</a>
                            </li>
                            <li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/manage/home') }}">工作台</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview  " v-bind:class="{active:menu.class=='system'}">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="{{url('/manage/system/permission')}}">模块权限</a>
                        </li>
