                            ...
                            <fieldset>
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <label><input type="radio" name="trend" value="1" v-model="bigtraffic.trend" checked/>去程</label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <label><input type="radio" name="type" value="1" v-model="bigtraffic.type" checked/>飞机</label>
