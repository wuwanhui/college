...
@section('content')
    ...
    <section class="content-header">
        <h1>
            新增线路
            <small>添加常用线路，以便发布团期时直接调用</small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="lineclass" class="col-sm-3 control-label">线路分类：</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label for="code" class="col-sm-3 control-label">线路编码：</label>
                                <div class="col-sm-3">
                                    <input id="code" type="text" class="form-control" value=""
                                           v-model="line.code" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-md-3 control-label">线路名称：</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="pic" class="col-sm-3 control-label">线路主图：</label>
                                <div class="col-sm-8">
                                    <input id="pic" type="text" class="form-control" value=""
                                           v-model="line.pic" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="special" class="col-sm-3 control-label">行程特色：</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="brieflyDesc" class="col-sm-3 control-label">简要描述：</label>
                                <div class="col-sm-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="days" class="col-sm-3 control-label">行程天数：</label>
                                        <div class="col-sm-2">
                                ...
                                <div v-for="item in parentline.travels">
                                    <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-9">
                                                        <div class="form-inline">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   placeholder="住宿"
                                                                   v-model="parentline.travels[$index].stay" value="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="xcontent" class="col-sm-3 control-label">行程内容：</label>
                                                    <div class="col-xs-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="xcontent" class="col-sm-3 control-label">行程内容：</label>
                                            <div class="col-xs-9">
                                                    <textarea class="form-control" id="xcontent" name="content"
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                changeStep: function (val) {
                    if ((val == 2 || val == 3) && this.line.id == null) {
                        layer.msg('请先完善线路基本信息！');
                        return;
                    }
                    this.steps = val;
                },
