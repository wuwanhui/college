                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="englishName" type="text" class="form-control" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <label><input type="radio" name="sex" value="男" v-model="guide.sex" checked/> 男</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <label><input type="radio" name="type" value="1" v-model="guide.type" checked/> 导游</label>
