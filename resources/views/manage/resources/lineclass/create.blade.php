                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="name" type="text" class="form-control auto" name="name"
                                                   value="" v-model="item.name" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="tag" type="text" class="form-control" name="tag"
                                                   value="" v-model="item.tag" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="sort" type="text" class="form-control auto" name="sort"
                                                   value="0" v-model="item.sort" required autofocus>
                                        </div>
                                    </div>
        ...
        var vm = new Vue({
            ...
            methods: {
                save: function () {
                    ...
                    this.$http.post("{{url('/manage/resources/lineclass/create')}}",_self.item).then(function (resspose) {
