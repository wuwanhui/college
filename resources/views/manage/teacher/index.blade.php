                        ...
                        <form method="get" class="form-inline">
                            <div class="input-group">
                                <select id="type" name="type" class="form-control" style="width: auto;"
                                    ...
                                    <option value="" selected>教师状态</option>
            ...
            <form method="Post" class="form-inline">
                <table class="table table-bordered table-hover  table-condensed">
                    ...
                    <tr v-for="item in list.data">
                        ...
                        <td style="text-align: center" v-text="$index"></td>
    ...
    <script type="application/javascript">
        var vm = new Vue({
            ...
            methods: {
                init: function () {
                    var _self = this;
                    this.$http.get("{{url('/manage/teacher?json')}}", {params: this.params})
                ...
                create: function () {
                    openUrl('{{url('/manage/teacher/create')}}', '新增教师', 800, 600);
                },
                edit: function (item) {
                    this.teacher = item;
                    openUrl('{{url('/manage/teacher/edit')}}?id=' + item.id, '编辑"' + item.name + '"教师', 800, 600);
                },
