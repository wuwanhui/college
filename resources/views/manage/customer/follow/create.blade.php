    ...
    <script type="application/javascript">
        ...
        var vm = new Vue({
            ...
            data: {
                ...
                follow: {customer_id: '', customer_linkman_id: ''},
                customer: {},
                customerList: [],
                linkManList: []
            },
            watch: {
                'follow.customer_id': function (val) {
                    this.linkManList = [];
                    if (val != '') {
                        this.initLinkMan(val);
                    }
            ...
            methods: {
                ...
                save: function (form) {
                    ...
                    this.$http.post("{{url('/manage/crm/customer/follow/create')}}", this.follow)
                            .then(function (response) {
                                        if (response.data.code == 0) {
                                            parent.msg('新增成功');
