                ...
                <form enctype="multipart/form-data" class="form-horizontal" customer="form" method="POST"
                    ...
                    <div class="box-body">
                        <div class="col-xs-12">
                            ...
                            <fieldset>
                                <legend>基本信息</legend>
                                <input type="hidden" v-model="customer.id" id="id" name="id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select id="type" name="type" class="form-control"
                                            ...
                                            <option v-for="(key,value) in initBase.typeList" v-bind:value="key"
                                                    v-text="value"
                                            ></option>
                                        </select>
                    ...
                    <div class="box-footer">
                        <div class="row">
                            <div class="col-xs-12  text-center">
                                ...
                                <button type="button" class="btn  btn-warning" v-on:click="delete()">删除
                                </button>
