                ...
                <fieldset>
                    <table class="table table-bordered table-hover  table-condensed">
                        ...
                        <tr style="text-align: center" class="text-center">
                            ...
                            <th style="width:120px;">出团日期</th>
                            <th style="width:80px;">计划人数</th>
                        ...
                        <tr v-for="item in list.data">
                            ...
                            <td style="text-align: center" v-text="item.tourline.lineclass.name"></td>
                            <td style="text-align: center" v-text="item.tourline.days"></td>
                            <td style="text-align: center;" v-text="item.departureDate"></td>
                            <td style="text-align: center" v-text="item.planCount"></td>
                            ...
                            <td style="text-align: center">
                                <a
                                        v-on:click="signUp(item.id)">报名</a>
                                |
                                <a
...
@section('script')
    <script type="application/javascript">
        //sidebar.menu = {type: 'business', item: 'group'};
        var vm = new Vue({
            el: '.content',
            data: {
